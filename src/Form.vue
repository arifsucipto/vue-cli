            ...
            <div class="col-xs-12">
                ...
                <form @submit.prevent="isSubmitted = true">
                    ...
                    <div class="form-group">
                        ...
                        <div v-for="media in formData.socialMedia" :key="media.index">
                    ...
                    <div class="form-group">
                        ...
                        <div v-for="category in formData.categories" :key="category.index">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="select-series" v-model="post.series">
                            ...
                            <option v-for="series in formData.series" :value="series" :key="series.index">{{ series }}</option>
                        </select>
                    </div>
                ...
                <table class="table table-striped" v-if="isSubmitted">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li v-for="media in post.shareOn" :key="media.index">{{ media }}</li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
